        ...
        $rootNode->children()
                 ->arrayNode('templates')
                     ...
                     ->children()
                         ...
                         ->scalarNode('change_password')->defaultValue('@NSSimpleUser/Login/base_change_password.html.twig')->end()
                         ->scalarNode('reset_password')->defaultValue('@NSSimpleUser/Login/base_reset_password.html.twig')->end()
