...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode->children()
                 ...
                 ->scalarNode('forgot_success')->defaultValue('@NSSimpleUser/Login/base_forgot_success.html.twig')
                 ->end()
                 ->scalarNode('change_password')->defaultValue('@NSSimpleUser/User/base_change_password.html.twig')
                 ->end()
